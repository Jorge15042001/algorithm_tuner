...
// configuration step. It creates a namespace called `algorithm_tuner`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", algorithm_tuner::cmake::project_name, algorithm_tuner::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", algorithm_tuner::cmake::project_version);
      return EXIT_SUCCESS;
    }
